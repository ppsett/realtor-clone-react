    ...
    <section>
        ...
        items-center px-6 py-12 max-w-6xl mx-auto">
            <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
                <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1973&q=80" 
                ...
                <form>
                    ...
                    <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
                        ...
                        <p>
                            ...
                            hover:text-blue-700 transition duration-200 ease-in-out ml-1">
                                Sign in instead
                            </Link>
                        </p>
                    </div>
